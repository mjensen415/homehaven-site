    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center text-primary-foreground">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-6 font-medium text-secondary">Serving all Homeowners in the North Bay</p>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl mb-8 leading-relaxed max-w-3xl mx-auto opacity-90">
            White-glove handyman and home maintenance service with premium subscription plans. Experience the
            convenience of professional home care without the hassle.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <BookingModal>
              <Button
                size="lg"
                className="bg-secondary hover:bg-secondary-hover text-secondary-foreground px-8 py-4 text-lg font-semibold group"
              >
